...
export const UI = () => {
  ...
  const getData = async () => {
    setLoading(true);
    await fetch(
      `/api/nominatif?page=${page}&pageSize=${pageSize}${
        ...
        return (
          <div className="flex justify-center gap-2">
            ...
            <Tooltip title="Proses">
              <ProsesTransfer currData={record} getData={getData} />
            </Tooltip>
          </div>
        );
      },
  ...
  return (
    <div>
      <Button
        ...
        size="small"
        disabled={
          ["BATAL", "SELESAI"].includes(currData.DetailDapem.statusCair)
            ? true
            : false
        }
      ></Button>
      <Modal
        ...
        footer={[
          <Button
            ...
            loading={loading}
            disabled={
              !data.DetailDapem.tanggalCair && !data.DetailDapem.buktiPencairan
                ? true
                : loading
            }
          >
      ...
      >
        <div className="m-3">
          <p>
            Lanjutkan untuk proses pencairan pengajuan{" "}
        ...
        <div className="m-3 flex flex-col gap-2">
          ...
          <InputUtil
            label="tanggalCair"
            value={data.DetailDapem.tanggalCair}
            type="Date"
            onChange={(e: string) =>
              setData((prev) => ({
                ...prev,
